      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen px-6 py-24 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-6">
          ...
          >
            ...
            <Link
              href="/auth/login"
              className="rounded-full border border-zinc-300 bg-white/90 px-6 py-3 text-sm font-semibold text-zinc-900 transition hover:border-zinc-950"
            >
              Log in
            </Link>
          </motion.div>
          ...
          <div className="bg-zinc-50 rounded-3xl p-8 border border-zinc-100">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm">Highly affordable chunked payments make adoption frictionless compared to lump sum policies.</p>
              </div>
              <Separator />
              <div>
                <div className="flex justify-between items-baseline mb-2">
